package nonda.cardata.httputil;
...
//    }
     ...
     * @throws Exception
     */
    public static HttpResult doPost(String url, Map<String, Object> map, Header header, StringEntity stringEntity) throws Exception {
        // 声明httpPost请求
...
//            httpPost.setHeader(header);
     ...
     * @throws Exception
     */
    public static HttpResult doPost(String url,Header header,StringEntity stringEntity) throws Exception {
        HttpResult httpResult = doPost(url, null, header,stringEntity);
        return httpResult;
    }
